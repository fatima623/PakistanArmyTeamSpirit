...
export const publicSite: typeof enPublicSite = {
  ...
  nav: {
    ...
    familiarization: "التعريف بـ PATS",
    awards: "الجوائز",
    gallery: "معرض الصور",
  ...
  gallery: {
    ...
    noImagesAvailable: "لا توجد صور متاحة لهذه الفئة.",
    noVideosAvailable: "لا توجد فيديوهات متاحة لهذه الفئة.",
    close: "إغلاق",
    previous: "السابق",
    next: "التالي",
  },
  ...
  pages: {
    awards: {
      ...
      rollTitle: "سجل النتائج",
      rollSubtitle: "جميع الدوريات المشاركة بإشارة النداء والجائزة المحققة.",
      rollColCallSign: "إشارة النداء",
      rollColUnit: "الوحدة",
      rollColAward: "الجائزة",
      rollFilterAll: "الكل",
      rollFilterAria: "تصفية النتائج حسب الجائزة",
      rollMedalCoin: "عملة تذكارية",
      rollMedalDnf: "لم تكمل",
      rollEmpty: "لا توجد دوريات في هذه الفئة",
      teamEyebrow: "الفريق",
