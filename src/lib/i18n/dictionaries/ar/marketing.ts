...
export const marketing: typeof enMarketing = {
  ...
  familiarization: {
    meta: {
      ...
      description:
        "‏إحاطة ما قبل الوصول للوحدات المشاركة — مفهوم PATS، والمسار، وتشكيل الفريق، وتخصيص الأسلحة والمعدات، والتدريب التعريفي.",
    },
    ...
    hero: {
      ...
      title: "‏التعريف بـ PATS",
      subtitle:
        "كل ما تحتاجه الوحدة المشاركة قبل الوصول — مفهوم التمرين، والمسار، وتشكيل الفريق، وتخصيص الأسلحة والمعدات، والتدريب التعريفي قبل التحرك.",
