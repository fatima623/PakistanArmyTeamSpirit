...
export const flights: typeof enFlights = {
  ...
  labels: {
    passport: "جواز السفر",
    flightTicket: "تذكرة الطيران (الذهاب)",
  ...
  form: {
    ...
    returnTicketDoc: "تذكرة العودة (PDF)",
    returnTicketDocHint: "رحلة العودة إلى الوطن. اختيارية — أضفها فور حجزها.",
    returnTicketLocked: "ارفع تذكرة الذهاب أولاً — يُفتح حقل تذكرة العودة بعدها مباشرة.",
    chooseFile: "اختر ملفًا",
    noFileChosen: "لم يتم اختيار ملف",
    keepFileHint: "الملف محفوظ بالفعل — اختر ملفًا جديدًا فقط لاستبداله.",
  ...
  submit: {
    title: "أرسل تسجيلك للاعتماد",
    desc:
      "تفاصيل الرحلة هي الخطوة الأخيرة. بعد أن يصبح لكل مسافر جواز سفر وتذكرة مرفوعان، أرسل التسجيل لتعتمده PATS.",
    action: "إرسال للاعتماد",
    reopen: "إعادة الفتح للتعديل",
    incomplete:
      "يجب أن يكون لكل عضو في الفريق جواز سفر وتذكرة مرفوعان قبل الإرسال.",
    submittedTitle: "تم إرسال التسجيل للاعتماد.",
    submittedSub:
      "ستقوم PATS بمراجعته. يمكنك إعادة فتحه ما دام قيد الانتظار.",
    submittedToast: "تم إرسال التسجيل للاعتماد",
    reopenedToast: "تمت إعادة فتح التسجيل للتعديل",
  },
  errors: {
    ...
    returnTicketLabel: "تذكرة العودة",
