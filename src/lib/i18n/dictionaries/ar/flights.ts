...
export const flights: typeof enFlights = {
  ...
  submit: {
    ...
    desc:
      "تفاصيل الرحلة هي الخطوة الأخيرة. بعد أن يصبح لكل مسافر جواز سفر وتذكرة مرفوعان، أرسل التسجيل لتعتمده المديرية الرياضية (SD).",
    ...
    submittedSub:
      "ستقوم المديرية الرياضية (SD) بمراجعته. يمكنك إعادة فتحه ما دام قيد الانتظار.",
