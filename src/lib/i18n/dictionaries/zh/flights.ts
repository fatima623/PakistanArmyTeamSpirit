...
export const flights: typeof enFlights = {
  ...
  form: {
    ...
    returnTicketDoc: "回程机票（PDF）",
    returnTicketDocHint: "返程行程。可选——订好后请尽快上传。",
    returnTicketLocked: "请先上传去程机票——回程机票字段会随即开放。",
    chooseFile: "选择文件",
    noFileChosen: "未选择文件",
    keepFileHint: "文件已在记录中——仅在需要替换时选择新文件。",
    saveChanges: "保存更改",
    submitFlight: "保存航班信息",
    cancel: "取消",
  },
