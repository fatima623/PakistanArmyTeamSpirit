...
export const workflow: WorkflowStrings = {
  ...
  sub: {
    ...
    approvedBySd: "Одобрено PATS",
    rejected: "Отклонено",
    underReviewBySd: "На рассмотрении PATS",
    pendingSdVerification: "Ожидает утверждения PATS",
    reviewAndSubmit: "Проверьте данные и отправьте",
    ensureDetailsCorrect: "Убедитесь, что все данные верны",
    available: "Доступно",
