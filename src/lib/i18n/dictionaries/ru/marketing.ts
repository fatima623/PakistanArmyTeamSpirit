...
export const marketing: typeof enMarketing = {
  ...
  familiarization: {
    meta: {
      ...
      description:
        "Материал для участвующих контингентов до прибытия — концепция PATS, местность и маршрут, состав команды, вооружение и снаряжение, координационные указания.",
    },
    ...
    hero: {
      ...
      title: "Ознакомление с PATS",
      subtitle:
        "Всё, что нужно участвующему контингенту до прибытия: концепция учения, характер местности и маршрут, состав команды, нормы вооружения и снаряжения, а также координационные указания, регулирующие порядок действий.",
      metaDuration: "Учение",
      metaDurationValue: "60 часов",
    ...
    anchors: {
      ...
      "dos-donts": "Можно и нельзя",
      facilitation: "Обеспечение",
    },
    ...
    terrain: {
      eyebrow: "Местность",
      title: "Характер местности",
      description:
        "Местность, которую пересекает патруль, и ожидаемые условия — ознакомьтесь до выбора обмундирования, обуви и режима действий в холодную погоду.",
      groundTitle: "Рельеф и грунт",
      demandTitle: "Требования к патрулю",
    },
    ...
    coordination: {
      eyebrow: "Координация",
      title: "Координационные указания",
      description:
        "Указания, изданные на основной конференции по планированию. Их несоблюдение может повлечь штрафные баллы или дисквалификацию.",
    },

    dosDonts: {
      eyebrow: "Порядок поведения",
      title: "Что можно и что нельзя",
      description:
        "Обязанности и запреты, действующие для каждого участника на всё время визита.",
      dos: "Можно",
      donts: "Нельзя",
    },
    ...
    facilitation: {
      eyebrow: "Обеспечение",
      title: "Обеспечение, медицина и правовые вопросы",
      description:
        "Что предоставляет Пакистанская армия, где проходит граница медицинской ответственности и какова правовая позиция, доведённая до всех участвующих стран.",
      facilitationTitle: "Предоставляет Пакистанская армия",
      medicalTitle: "Медицинское обеспечение",
      legalTitle: "Правовые аспекты",
      informationTitle: "Сведения, предоставляемые командами",
      informationDeadline: (deadline: string): string => `Срок — ${deadline}`,
    },
